...
pip install --upgrade google-api-python-client requests bs4 httplib2 lxml oauth2client apiclient


### Debian & Ubuntu

apt install python3-googleapi python3-oauth2client python3-bs4 python3-lxml python3-requests python3-oauth2client python3-httplib2
...
pip3 install --upgrade google-api-python-client requests bs4 lxml httplib2 oauth2client apiclient
